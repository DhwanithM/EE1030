...
# Circle parameters
center = np.array([7/2, 7/2])  # Center of the circle
radius =  4.949 # Radius of the circle
...
# Plotting
plt.plot(x_circ, y_circ, label='Circle (Radius = 4.949) when a=b=7', color='blue')
...
plt.savefig('../figs/plot.png', format='png', bbox_inches='tight')
